...
export const ABOUT_SEO: SeoMeta = { title: "About SSCSS | Security Company in Bengaluru Since 2008", description: ABOUT.heroSubtitle, canonicalPath: ROUTES.about, schemaType: "WebPage" };
